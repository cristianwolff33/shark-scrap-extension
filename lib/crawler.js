...
/** Normalizuje URL do deduplikacji skanu: usuwa hash, zostawia query. */
...
/**
 * Decyduje, czy paginacja nadaje się do automatycznego, bezobsługowego podążania PRZEZ FETCH
 * PO URL-ACH (czyli tak jak next_link — kolejne strony jako osobne adresy). "load_more" ma
 * osobną, realną obsługę w content/detector.js (autoExpandLoadMore) — kliknięcie przycisku na
 * ŻYWEJ stronie, bo tam jest prawdziwy DOM do klikania, czego statyczny fetch+DOMParser nie
 * odtworzy. "infinite_scroll" (doładowanie samym scrollem, bez przycisku) zostaje nieobsłużone
 * — nie ma dla niego jednego niezawodnego triggera do automatyzacji.
 */
