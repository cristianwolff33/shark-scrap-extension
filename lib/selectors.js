...
/**
 * Zwraca pierwszy pasujący atrybut testowy (data-testid/data-test/data-qa/...) elementu,
 * albo null. Używane jako fallback grupowania kart listingu, gdy element nie ma żadnej
 * "stabilnej" klasy (np. wyłącznie hashowane klasy css-in-js/CSS modules) — patrz
 * content/detector.js. To ten sam zestaw atrybutów, którego generateSelector już
 * używa jako priorytet nad ścieżką tag.klasa.
 * @param {Element} el
 * @returns {{attr: string, value: string} | null}
 */
export function pickTestId(el) {
