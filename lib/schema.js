 ...
 * @property {"none"|"next_link"|"load_more"|"click_next"|"infinite_scroll"} mode
...
export function createDefaultConfig(domain, startUrl) {
  return {
    ...
    list_page: {
      ...
      url_selector: "",
      url_attribute: "href",
      pagination: { mode: "none", next_selector: "", load_more_selector: "", max_pages: 50, experimental: false },
    },
    fields: {},
