/**
 * @file Eksport finalnych wierszy adapter-request do CSV/XLSX/JSON. Wtyczka działa bez bridge'a:
...
// "base_action" to DRUGI, osobny rozmiar używany przez Rozetkę konkretnie w polu JSON-LD
// "image" (240x296px) — inny niż "/medium/" widoczny w DOM, więc wymaga osobnego wpisu.
const SMALL_SIZE_PATH_SEGMENT_RE = /\/(thumbs?|thumbnails?|mini|tiny|icon|preview|small|medium|mid|base_action)\//i;
