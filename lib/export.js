 ...
 * stringa miniaturek. To WYŁĄCZNIE heurystyki — żaden zwrócony URL nie jest gwarantowany, że
 * istnieje (plik może naprawdę się tak nazywać, strona może nie używać żadnej z tych konwencji).
 * WYWOŁUJĄCY MUSI zweryfikować każdy kandydat realnym fetch() i spaść na oryginalny URL, jeśli
 * żaden nie zadziała — nigdy nie ufamy temu w ciemno (patrz fetchImageWithFullSizeUpgrade w
 * sidepanel/main.js). Zwraca [] (pustą listę), gdy URL nie pasuje do żadnego wzorca.
 * @param {string} url
 * @returns {string[]}
 */
