 ...
 * frameworka/cloud. `openai:settings` trzyma local/dev klucz OpenAI + model tylko dla trybu
 * lokalnego; w Cloud mode AI idzie przez backend i nie wymaga klucza LLM w Chrome.
 */
